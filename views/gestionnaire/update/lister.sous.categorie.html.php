...
?>
  ...
  <h3 class="abdou" style="margin-left:40%;color:#f17503;margin-top:-10%;">Liste des sous_categories</h3>
     ...
     if (!isset($_GET['page'])) {
      ...
      $nombrePage=nombrePageTotal($_SESSION['sous_categories'],6);
      $sous_categorie=get_element_to_display(  $_SESSION['sous_categories'],$page,6);  
      }
      if (isset($_GET['page'])) {
        $page=$_GET['page'];
        $ok1=$ok1;
...
<thead class="ok1" style="border:2px solid black;">
    ...
    <th scope="col" class="gueye" style="border:2px solid black;">id_sous_categorie</th>
    <th scope="col"  class="gueye" style="border:2px solid black;">nom_sous_categorie</th>
...
<?php foreach ($sous_categorie as $key => $value):?>
    <tr class="ok" style="border:2px solid black;">
    

    <td class="gueye" style="border:2px solid black;"><?php echo $value['id_sous_categorie'];?></td>
    <td class="gueye" style="border:2px solid black;"><?php echo $value['nom_sous_categorie'];?></td>
    <td class="gueye" style="border:2px solid black;"><?php echo $value['id_categorie'];?></td>
    <td class="gueye" style="color:#f17503;">
        <a name="" id="" class="btn btn" href="<?= WEB_ROUTE.'?controllers=sous.categorie&views=modification&id='.$value['id_sous_categorie'] ?>" role="button">
