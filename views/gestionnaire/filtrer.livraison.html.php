...
?>
  ...
  <h3 class="abdou" style="margin-left:30%;color:#f17503;margin-top:-10%;">Liste des categories</h3>
        ...
        <form   action="<?= WEB_ROUTE ?>" method="POST" > 
                    <input type="hidden" name="controllers" value="livraison">
                    <input type="hidden" name="action" value="filtrer.livraison">
            <div class="row">

                <div class="col-md-2">
                <div class="form-group">
                  <label for="Etat">Etat</label>
                  <select class="form-control" name="etat_livraison" id="">
            ...
            <div class="form-group">
                  ...
                  <input type="date"
                    class="form-control" name="date_livraison" id="" aria-describedby="helpId" placeholder="">
...
<?php foreach ($livraison as $key => $value):?>
    ...
    <td class="gueye" style="border:2px solid black;"><?php echo $value['date_livraison'];?></td>
