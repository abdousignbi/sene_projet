...
<div class="jumbotron text-center p-3 bg-white" style="margin-left:13%; margin-right:0%">
            <h1 class="display-3"> Nos produits Informatiques</h1>  
          </div>
...
<div class="container-fluid  " style="margin-top:0%; width:70%;">
     ...
     ?>
        ...
        <?php foreach ($image as $key => $value):?>
            <?php if (str_contains($value['nom_image'], 'bu')==true):?>
     <div class="col-md-4">
        ...
        <div class="col-sm-4 offset-sm-4">
          ...
          <?php if($page<=1):?>
              <li class="page-item disabled ">
                <a class="page-link desable" href="<?=WEB_ROUTE.'?controllers=user&views=informatique&page='.$precedent?>">&laquo;</a>
              </li>
              <?php else:?>
                <li class="page-item ">
                <a class="page-link" href="<?=WEB_ROUTE.'?controllers=user&views=informatique&page='.$precedent?>">&laquo;</a>
              </li>
                <?php endif ?>
              
              <?php if($page==2):?>
              <li class="page-item active">
                <a class="page-link" href="<?=WEB_ROUTE.'?controllers=user&views=informatique&page='.$ok2?>">1</a>
              </li>
              <?php elseif($page!=2):?>
                <li class="page-item ">
                <a class="page-link" href="<?=WEB_ROUTE.'?controllers=user&views=informatique&page='.$ok2?>">1</a>
              ...
              <?php if($page==3):?>
              <li class="page-item active">
                <a class="page-link" href="<?=WEB_ROUTE.'?controllers=user&views=informatique&page='.$ok3?>">2</a>
              </li>
              <?php elseif($page!=3):?>
                <li class="page-item ">
                <a class="page-link" href="<?=WEB_ROUTE.'?controllers=user&views=informatique&page='.$ok3?>">2</a>
              ...
              <li class="page-item disable">
                <a class="page-link " href="<?=WEB_ROUTE.'?controllers=user&views=informatique&page='.$suivant?>">&raquo;</a>
              </li>
