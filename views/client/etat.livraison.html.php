...
?>
  ...
  <h3 class="abdou" style="margin-left:40%;color:#f17503;margin-top:-10%;">Liste des produits</h3>
     ...
     if (!isset($_GET['page'])) {
      $page=1;
      $_SESSION['livraisons'] = $livraisons;
      $nombrePage=nombrePageTotal($_SESSION['livraisons'],6);
      $livraison=get_element_to_display(  $_SESSION['livraisons'],$page,6);  
      }
      if (isset($_GET['page'])) {
        $page=$_GET['page'];
        $ok1=$ok1;
...
<thead class="ok1" style="border:2px solid black;">
    ...
    <th scope="col" class="gueye" style="border:2px solid black;">Date_livraison</th>
    <th scope="col"  class="gueye" style="border:2px solid black;">Etat_livraison</th>
    <th scope="col"  class="gueye" style="border:2px solid black;">montant_livraison</th>
...
<?php foreach ($livraison as $key => $value):?>
    <tr class="ok" style="border:2px solid black;">
    

    <th class="gueye" style="border:2px solid black;" scope="row"><?php echo $value['date_livraison'];?></th>
    <td class="gueye" style="border:2px solid black;"><?php echo $value['etat_livraison'];?></td>
    <td class="gueye" style="border:2px solid black;"><?php echo $value['montant_livraison'];?></td>
